import sys
from PyQt6.QtWidgets import QApplication, QMainWindow, QMessageBox, QAbstractItemView, QTableWidgetItem, QLineEdit
...
class HomeWindow(QMainWindow):
    def __init__(self, username, current_user_role):
        ...
        self.tableWidget.cellDoubleClicked.connect(self.confirm_delete_employee)
        self.employee_id = 1
        self.salary_map = {
            "Kế toán trưởng": "10,000,000 VNĐ",
            "Kế toán": "8,000,000 VNĐ", 
    ...
    def get_role(self):
        ...
        try:
            ...
            pass
        return "Staff"
    def confirm_delete_employee(self, row, column):
